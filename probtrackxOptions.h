...
inline probtrackxOptions::probtrackxOptions() :
		verbose(string("-V,--verbose"), 0, string("Verbose level, [0-2]"),
				false, requires_argument), help(string("-h,--help"), false,
				string("Display this message\n\n"), false, no_argument),

		basename(string("-s,--samples"), "",
				string("Basename for samples files - e.g. 'merged'"), true,
				requires_argument),

		outfile(string("-o,--out"), string("fdt_paths"),
				string("Output file (default='fdt_paths')"), false,
				requires_argument),
		...
		maskfile(string("-m,--mask"), "",
				string("Bet binary mask file in diffusion space"), true,
				requires_argument),
		...
		simpleout(string("--opd"), false,
				string("\tOutput path distribution"), false, no_argument),
		...
		omeanpathlength(string("--ompl"), false,
				string("\tOutput mean path length from seed"), false,
				no_argument),

		pathfile(string("--fopd"), "",
				string("\tOther mask for binning tract distribution"), false,
				requires_argument),

		s2tout(string("--os2t"), false,
				string("\tOutput seeds to targets"), false, no_argument),

		s2tastext(
				string("--s2tastext"), false,
				string("Output seed-to-target counts as a text file (default in simple mode)\n\n"),
				false, no_argument),

		closestvertex(string("--closestvertex"),
				false,
		...
		noprobinterpol(string("--noprobinterpol"),
				false,
